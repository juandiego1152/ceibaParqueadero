...
//
//        val request = FakeRequest(POST, "/parqueaderoCeiba/ceibajdl/v0.1/guardar-registro").withJsonBody(Json.parse("""{ "placaVehiculo": "ALS211","tipoVehiculo": "Carro","esAltoCilindraje":false}"""))
//
